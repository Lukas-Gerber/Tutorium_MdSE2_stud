...
public:
    Waterpokemon(Game* parent,const std::string &name, int level, int hitpoints, int pokedexNumber)
            : Pokemon(parent, name, level, hitpoints, pokedexNumber), enumType(Water)
            {
